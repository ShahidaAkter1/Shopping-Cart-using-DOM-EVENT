...
document.getElementById('first-card').addEventListener('click',function(){
    ...
    //show the data
    // create table row
    const container=document.getElementById('table-container');//get paren using id
...
document.getElementById('second-card').addEventListener('click',function(e){
    ...
    const sumTotal=parseInt(productPrice) + parseInt(productQuantity);//add
...
document.getElementById('third-card').addEventListener('click',function(){
    ...
    const priceTotal= parseInt(productPrice) - parseInt(productQuantity);//total price 
    // console.log(priceTotal,typeof priceTotal);
